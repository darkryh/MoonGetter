...
class Factory(
    ...
    class Builder {
         ...
         */
        fun identifier(url: String): String? = MoonFactory.identifier(
            url = url.ifEmpty {
         ...
         */
        fun identifier(urls: List<String>): List<String> = MoonFactory.identifierList(
            urls = urls.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
         ...
         */
        suspend fun get(url: String): Server? = MoonFactory.create(
            url = url.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
         ...
         */
        @ExperimentalFeature
        suspend fun get(urls: List<String>): List<Server> = MoonFactory.creates(
            urls = urls.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
         ...
         */
        suspend fun getUntilFindResource(urls: List<String>): Server? = MoonFactory.createUntilFindResource(
            urls = urls.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
