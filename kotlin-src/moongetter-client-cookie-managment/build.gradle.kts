...
mavenPublishing {
    ...
    pom {
        name.set("MoonGetter Client Cookie Managment")
        description.set("Cookie Managment module for MoonGetter resource extraction tool")
...
kotlin {
    ...
    val xcfName = "MoonGetter-Client-Cookie-Managment-MultiplatformKit"
