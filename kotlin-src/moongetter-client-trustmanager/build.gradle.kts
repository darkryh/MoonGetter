...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "moongetter-client-trustmanager",
        version = moonGetterVersion
    )

    pom {
        name.set("MoonGetter Client TrustManager")
        description.set("Client TrustManager module for MoonGetter validations for net enviroment")
...
kotlin {
    ...
    val xcfName = "MoonGetter-Client-TrustManager-MultiplatformKit"
