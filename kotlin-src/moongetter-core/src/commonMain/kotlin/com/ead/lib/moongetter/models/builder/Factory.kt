...
class Factory(
    ...
    class Builder {
         ...
         */
        internal fun identifier(url: String): String? = MoonCoreFactory.identifier(
            url = url.ifEmpty {
         ...
         */
        internal fun identifier(urls: List<String>): List<String> = MoonCoreFactory.identifierList(
            urls = urls.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
         ...
         */
        internal suspend fun get(url: String): Server = MoonCoreFactory.create(
            url = url.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
         ...
         */
        @ExperimentalFeature
        internal suspend fun get(urls: List<String>): List<Server> = MoonCoreFactory.creates(
            urls = urls.ifEmpty {
                throw InvalidServerException(Resources.NO_PARAMETERS_TO_WORK, Error.NO_PARAMETERS_TO_WORK)
            },
            serversFactory = engine.servers.ifEmpty {
