...
mavenPublishing {
    ...
    pom {
        name.set("MoonGetter Core")
        description.set("Core library for MoonGetter resource extraction tool and fundamentals")
...
kotlin {
    ...
    val xcfName = "MoonGetter-Core-MultiplatformKit"
