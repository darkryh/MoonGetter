...
mavenPublishing {
    ...
    coordinates(
        groupId = "com.ead.lib",
        artifactId = "moongetter-jsunpacker",
        version = moonGetterVersion
    )

    pom {
        name.set("MoonGetter JsUnpacker")
        description.set("Unpacker module for MoonGetter resource extraction process")
...
kotlin {
    ...
    val xcfName = "MoonGetter-JsUnpacker-MultiplatformKit"
