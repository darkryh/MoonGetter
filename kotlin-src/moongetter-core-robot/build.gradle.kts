...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "moongetter-robot",
        version = moonGetterVersion
    )

    pom {
        name.set("MoonGetter Robot")
        description.set("Robot module for MoonGetter resource extraction tool and fundamentals on web environment")
...
kotlin {
    ...
    val xcfName = "MoonGetter-Core-Robot-MultiplatformKit"
